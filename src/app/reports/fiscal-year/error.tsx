...
export default function Error({ error, reset }: ErrorProps) {
  return (
    <div className="flex flex-col gap-4">
      <h1 className="font-display text-2xl font-semibold text-foreground">Fiscal Year Report</h1>
      <div className="rounded-lg border border-danger/30 bg-danger-bg p-6 text-center">
        <p className="text-sm text-danger">Something went wrong while loading the fiscal year report.</p>
        {error.digest && (
